...
export type DimensionWeights = typeof DEFAULT_WEIGHTS;

// Active weights — overridden per-user by the learning engine
...
function scoreCommunication(a: Profile, b: Profile): DimensionScore {
...
export function computeMatch(a: Profile, b: Profile, customWeights?: Partial<DimensionWeights>): MatchResult {
