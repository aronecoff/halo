...
export default function Home() {
  ...
  // Show saving state while profile is being finalized
  if (savingProfile) {
    return (
      <div style={{
        ...
        <p style={{ fontSize: 11, color: "#6B7280", maxWidth: 240, textAlign: "center", lineHeight: 1.5 }}>
          IRIS is analyzing your conversation and constructing your personality map.
        </p>
      </div>
    );
  }
