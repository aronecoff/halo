    ...
    <ScreenWrap k="matchFound">
      <div style={{ flex: 1, overflowY: "auto", padding: "12px 16px 24px" }}>
        ...
        <div className="fade-up fade-up-5" style={{ display: "flex", gap: 10, marginBottom: 12 }}>
          ...
          <motion.button whileTap={{ scale: 0.98 }} onClick={onDecline} style={{ flex: 1, height: 48, borderRadius: 14, background: "transparent", border: "1px solid rgba(107,114,128,0.3)", color: "#9CA3AF", fontSize: 12, fontWeight: 700, letterSpacing: 1.5, textTransform: "uppercase", cursor: "pointer" }}>
            DECLINE
          </motion.button>
        </div>
